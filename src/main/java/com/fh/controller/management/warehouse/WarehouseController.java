package com.fh.controller.management.warehouse;
...
public class WarehouseController extends BaseController {
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改Warehouse");
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表Warehouse");
		...
		page.setPd(pd);
		List<PageData>	varList = warehouseService.list(page);	//列出Warehouse列表
		mv.setViewName("management/warehouse/warehouse_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("management/warehouse/warehouse_edit");
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除Warehouse");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"导出Warehouse到excel");
