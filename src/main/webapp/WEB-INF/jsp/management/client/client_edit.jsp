					...
					<form action="client/${msg }.do" name="Form" id="Form" method="post">
						...
						<table style="border-collapse:separate; border-spacing:10px;width: 100%;padding-left: 1%">
							<tr>
								...
								<td><input type="number" name="FITEMID" id="FITEMID" value="${pd.FITEMID}" maxlength="32" placeholder="这里输入FItemID" title="FItemID" style="width:100%;"/></td>
							</tr>
							<tr>
								<td style="width:6%;text-align: right;">客户编码<span style="color: red;">*</span>:</td>
								<td><input type="text" name="FNUMBER" id="FNUMBER" value="${pd.FNUMBER}" maxlength="255" placeholder="这里输入客户编码" title="客户编码" style="width:100%;"/></td>
							</tr>
							<tr>
