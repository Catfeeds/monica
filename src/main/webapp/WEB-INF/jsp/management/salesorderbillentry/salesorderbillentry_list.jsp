							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr name="listBeen" id="tr${var.SALESORDERBILLENTRY_ID}" onclick="toCheck('${var.SALESORDERBILLENTRY_ID}')">
											<td class='center'>
												<label class="pos-rel"><input type='checkbox' id="${var.SALESORDERBILLENTRY_ID}" name='ids' value="${var.SALESORDERBILLENTRY_ID}" class="ace" /><span class="lbl"></span></label>
											</td>
											<td class='center' style="width: 30px;">${vs.index+1}</td>
											<td class='center'>${var.FCOMMODITYID}</td>
											<td class='center'>${var.FQTY}</td>
											<td class='center'>${var.FAMOUNT}</td>
											<td class='center'>${var.FSALESORDERBILLID}</td>
